...
class task_state_estimator:
    ...
    def __init__(self,
        ...
        _ad = [
            ...
            [-0.0,         0.81782232, -0.00285708,  0.00285708],
            [-0.0001031,   0.00060186,  0.56539207,  0.10492794],
            [-0.0001031,  -0.00060186,  0.10492794,  0.56539207],
        ]
        _bd = [
            [ 0.00019526,  0.00019526,  0.12318086,  0.12318086,  0.0,        0.0       ],
            [-0.00234551,  0.00234551, -0.01342323,  0.01342323,  0.18017762, 0.00309313],
            [ 1.06089633,  0.08968669,  9.59e-05,    7.2e-06,    -0.00059525,-0.55608711],
            [ 0.08968669,  1.06089633,  7.2e-06,     9.59e-05,    0.00059525, 0.55608711],
        ]
        if _HAVE_ULAB:
